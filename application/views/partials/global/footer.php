...
<script src="<?php echo site_url('assets/app-assets/vendors/js/charts/gmaps.min.js');?>" type="text/javascript"></script>
<script src="<?php echo site_url('assets/app-assets/vendors/js/forms/icheck/icheck.min.js');?>" type="text/javascript"></script>
<script src="<?php echo site_url('assets/app-assets/vendors/js/extensions/jquery.knob.min.js');?>" type="text/javascript"></script>
...
<!-- END STACK JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="<?php echo site_url('assets/app-assets/js/scripts/pages/dashboard-fitness.js');?>" type="text/javascript"></script>
<script src="<?php echo site_url('assets/app-assets/js/scripts/cards/card-maps.js');?>" type="text/javascript"></script>
<script src="<?php echo site_url('assets/app-assets/js/scripts/charts/gmaps/routes.js');?>" type="text/javascript"></script>
<script type="text/javascript">
    ...
    function initializeMap() {
        // Map options
        var opts = {
            center: new google.maps.LatLng(-25.9701129, 28.128212),
            zoom: 6,
